  ...
  <div className="coverPage">
    ...
    <section className="coverPage_ui">
      <div className="coverPage_ui_wrapper">
        ...
        <p className="coverPage_ui_wrapper_line">Where trade come alive</p>
        <button onClick={handleLogin} disabled={disableLogin}>
          Get Started
        </button>
        <p className="coverPage_ui_wrapper_tech">powered by Airswap & 3Box</p>
      </div>
    </section>
  </div>
);
